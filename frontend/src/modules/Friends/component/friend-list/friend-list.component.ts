...
import { SuggestService } from '../../services/suggested.service';
import { SendFriendRequestService } from '../../services/send_friend_request.services';
...
@Component({
  ...
  providers: [SuggestService, SendFriendRequestService, RejectRequestService,AuthService], // Include the RejectRequestService in providers
})
export class FriendListComponent {
  ...
  constructor(
    ...
    private rejectRequest: RejectRequestService ,
